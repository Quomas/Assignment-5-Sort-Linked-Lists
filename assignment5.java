...
class List<T> {
  ...
  public List<T> splitAt(int index) {
    ...
    if (index < 0 || index > this.size) {
        System.out.println("Index out of bounds!"); // make sure index is in bounds
        return newList;
    }
    ...
    // If splitting at 0 it goes to newList
    if (index == 0) {
    ...
    public void insertSorted(T item) {
        ...
        // its empty or it inserts at front
        if (this.head == null || ((Integer)item) < ((Integer)this.head.getElement())) {
            newNode.setNext(this.head);
            this.head = newNode;
            this.size++;
            return;
        ...
        // cycle through list while temp is less than the integer
        while (temp.getNext() != null &&
                ((Integer)temp.getNext().getElement()) < ((Integer)item)) {
            temp = temp.getNext();
        }
    ...
    public void insertionSort() {
        ...
        // split at N/2 (+1 if odd)
        int mid = (this.size % 2 == 0) ? (this.size / 2) : (this.size / 2 + 1);
        ...
        // merges using insertSorted
        Node<T> temp = right.head;

        while (temp != null) {
            left.insertSorted(temp.getElement());
            temp = temp.getNext();
        }
    }
}
...
public class assignment5 {
  ...
  public static void main(String[] args) { // The main() method
    ...
    do{
      ...
      System.out.println( "88: split list");
      ...
      switch (ch) {
        ...
        case 11:
          ...
          break;
        case 88:
          System.out.println("enter index to split:");
          index = sc.nextInt();
          System.out.println("Original List BEFORE split:");
          list.displayAll();
          List<Integer> newList = list.splitAt(index);
          System.out.println("Left List (modified L):");
          list.displayAll();
          System.out.println("Right List (new list):");
          newList.displayAll();
          break;
        case 99:
          list.insertionSort();
